...
// pub type Intensidad = Intensidad;
// impl Fluye for Intensidad {}

// pub type Elemento = Cíclico;//<Elemento>;
// pub type Direccion = Cíclico;//<Direccion>;
// pub type TipoGuerrero = Acíclico;//<TipoGuerrero>;
// pub type TipoEnergía = Acíclico;//<TipoEnergía>;
// pub type EtapaCamino = Acíclico;//<EtapaCamino>;
pub enum Ambito {
  Tonal{
    época: String,
